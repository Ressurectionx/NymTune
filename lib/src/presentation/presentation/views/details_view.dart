...
class _DetailsViewState extends State<DetailsView> {
  ...
  Widget buildAudioPlayerWidget(BuildContext context) {
    final SongProvider _homeProvider = Provider.of<SongProvider>(context);
    final Song? song = _homeProvider.currentSong;
    final Duration? duration = _homeProvider.duration;
    final Duration? position = _homeProvider.position;
    final bool isPlaying = _homeProvider.isPlaying;
      ...
      children: [
        ...
        SliderTheme(
          ...
          child: Slider(
            ...
            onChanged: (value) {
              _homeProvider.seek(Duration(seconds: value.toInt()));
            },
          ),
        ),
        Padding(
...
//             inactiveTrackColor: AppColors.dark3(),
...
//                       .copyWith(color: AppColors.greenYellow(), fontSize: 12)),
...
//                 child: Center(
//                   child: Icon(
//                     _isPlaying ? CupertinoIcons.pause_fill : Icons.play_arrow,
//                     size: 30,
//                     color: AppColors.dark2(),
//                   ),
//                 ),
